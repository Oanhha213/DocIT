...
namespace API2
{
    ...
    partial void InserttblKhach2(tblKhach2 instance);
    partial void UpdatetblKhach2(tblKhach2 instance);
    partial void DeletetblKhach2(tblKhach2 instance);
    #endregion
		...
		public System.Data.Linq.Table<tblKhach2> tblKhach2s
		{
			get
			{
				return this.GetTable<tblKhach2>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblKhach2")]
	public partial class tblKhach2 : INotifyPropertyChanging, INotifyPropertyChanged
	{
