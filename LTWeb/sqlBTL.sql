...
insert into LOAISP values (N'ADAPTER', N'Củ sạc')
insert into LOAISP values (N'CABLE', N'Cáp sạc')
insert into LOAISP values (N'POWERBANK', N'Sạc dự phòng')
insert into LOAISP values (N'SDCARD', N'Thẻ nhớ')
insert into LOAISP values (N'EARPODS', N'Tai nghe')

-- cập nhật mã loại phụ kiện thành mã loại mới, mã cũ = 'LOAI02'
DELETE FROM LOAISP WHERE MaLoai = 'LOAI02'
UPDATE SANPHAM SET MaLoai = 'ADAPTER' WHERE MaSP = 'PK01' or MaSP = 'PK02' or MaSP = 'PK03' or MaSP = 'PK04' or MaSP = 'PK05'
UPDATE SANPHAM SET MaLoai = 'CABLE' WHERE MaSP = 'PK06' or MaSP = 'PK07' or MaSP = 'PK08'
UPDATE SANPHAM SET MaLoai = 'SDCARD' WHERE MaSP = 'PK09' or MaSP = 'PK10' or MaSP = 'PK11' or MaSP = 'PK12'
...
INSERT INTO SANPHAM VALUES
(N'PK01', N'Củ sạc điện thoại Samsung 2 cổng', N'ADAPTER', N'MHSX01', N'cusac.1.jpg', 5, N'Power Delivery đáp ứng được nhiều mức sạc khác nhau, đảm bảo mỗi thiết bị giao tiếp và xác nhận chính xác mức năng lượng mà thiết bị yêu cầu nhờ đó quá trình sạc an toàn, hạn chế chai pin', N'Màu trắng', 100 , 12),
(N'PK02', N'Củ sạc đa năng', N'ADAPTER', N'MHSX01', N'cusac.2.jpg', 5, N'Power Delivery đáp ứng được nhiều mức sạc khác nhau, đảm bảo mỗi thiết bị giao tiếp và xác nhận chính xác mức năng lượng mà thiết bị yêu cầu nhờ đó quá trình sạc an toàn, hạn chế chai pin', N'Màu đen', 100 , 12),
(N'PK03', N'Củ sạc nhanh Samsung', N'ADAPTER', N'MHSX01', N'cusac.3.jpg', 5, N'Power Delivery đáp ứng được nhiều mức sạc khác nhau, đảm bảo mỗi thiết bị giao tiếp và xác nhận chính xác mức năng lượng mà thiết bị yêu cầu nhờ đó quá trình sạc an toàn, hạn chế chai pin', N'Màu trắng', 100 , 12),
(N'PK04', N'Củ sạc nhanh 20W', N'ADAPTER', N'MHSX01', N'cusac.6.jpg', 5, N'Power Delivery đáp ứng được nhiều mức sạc khác nhau, đảm bảo mỗi thiết bị giao tiếp và xác nhận chính xác mức năng lượng mà thiết bị yêu cầu nhờ đó quá trình sạc an toàn, hạn chế chai pin', N'Màu trắng', 100 , 12),
(N'PK05', N'Củ sạc OPPO', N'ADAPTER', N'MHSX06', N'cusac.jpg', 5, N'Power Delivery đáp ứng được nhiều mức sạc khác nhau, đảm bảo mỗi thiết bị giao tiếp và xác nhận chính xác mức năng lượng mà thiết bị yêu cầu nhờ đó quá trình sạc an toàn, hạn chế chai pin', N'Màu đen', 100 , 12),
(N'PK06', N'Cáp Lightning Iphone', N'CABLE', N'MHSX02', N'daysac.2.jpg', 5, N'Cáp dài 1m, cùng dòng sạc tối đa 2.4A, giúp bạn thuận tiện hơn trong việc sạc pin cho điện thoại', N'Màu đen', 100 , 12),
(N'PK07', N'Cáp sạc USB fast charging', N'CABLE', N'MHSX01', N'daysac.3.jpg', 5, N'Cáp dài 1m, cùng dòng sạc tối đa 2.4A, giúp bạn thuận tiện hơn trong việc sạc pin cho điện thoại', N'Màu đen', 100 , 12),
(N'PK08', N'Cáp sạc Samsung chính hãng', N'CABLE', N'MHSX01', N'daysac.jpg', 5, N'Cáp dài 1m, cùng dòng sạc tối đa 2.4A, giúp bạn thuận tiện hơn trong việc sạc pin cho điện thoại', N'Màu đen', 100 , 12),
(N'PK09', N'Thẻ nhớ Kingston 64GB', N'SDCARD', N'MHSX01', N'thenho.1.jpg', 5, N'Tốc độ đọc lên đến 100 MB/s, tốc độ ghi là 30 MB/s. Tương thích tốt với điện thoại, máy tính bảng, máy ảnh, laptop,...', N'Màu đen', 100 , 12),
(N'PK10', N'Thẻ nhớ Sandisk 128GB', N'SDCARD', N'MHSX01', N'thenho.5.jpg', 5, N'Tốc độ đọc lên đến 100 MB/s, tốc độ ghi là 30 MB/s. Tương thích tốt với điện thoại, máy tính bảng, máy ảnh, laptop,...', N'Màu đen', 100 , 12),
(N'PK11', N'USB Sandisk 128GB', N'SDCARD', N'MHSX01', N'thenho.4.jpg', 5, N'Tốc độ đọc lên đến 100 MB/s, tốc độ ghi là 30 MB/s. Tương thích tốt với điện thoại, máy tính bảng, máy ảnh, laptop,...', N'Màu đen', 100 , 12),
(N'PK12', N'Thẻ nhớ Mixie 32GB', N'SDCARD', N'MHSX01', N'thenho.3.jpg', 5, N'Tốc độ đọc lên đến 100 MB/s, tốc độ ghi là 30 MB/s. Tương thích tốt với điện thoại, máy tính bảng, máy ảnh, laptop,...', N'Màu đen', 100 , 12);
...
select * from SANPHAM where MaLoai = N'LOAI01'